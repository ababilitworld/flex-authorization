<?php
namespace Ababilithub\FlexAuthorization\Package\Plugin\Posttype\V1\Concrete\Permission\Presentation\Template\Single;
                    ...
                    <div class="post-main-content">
                        ...
                        <section class="post-section property-details">
                            <h2 class="section-title">
                                ...
                                <?php esc_html_e('Permissionrmation', 'flex-eland'); ?>
                            </h2>
