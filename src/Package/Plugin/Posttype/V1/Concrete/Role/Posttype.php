<?php
namespace Ababilithub\FlexAuthorization\Package\Plugin\Posttype\V1\Concrete\Role;
...
use Ababilithub\{
    ...
    FlexAuthorization\Package\Plugin\Posttype\V1\Concrete\Role\Presentation\Template\Single\Template as PosttypeTemplate,
    FlexAuthorization\Package\Plugin\Posttype\V1\Concrete\Role\PostMeta\PostMetaBox\Manager\PostMetaBox as RolePostMetaBoxManager,
    FlexAuthorization\Package\Plugin\Posttype\V1\Concrete\Role\PostMeta\PostMetaBoxContent\Manager\PostMetaBoxContent as RolePostMetaBoxContentManager,
...
{ 
    ...
    public function init_hook(): void
    {
        ...
        add_action('add_meta_boxes', function () {
            (new RolePostMetaBoxManager())->boot();
        });

        add_action('add_meta_boxes', function () {
            (new RolePostMetaBoxContentManager())->boot();
        });

        add_action('save_post', function ($post_id, $post, $update) {
            (new RolePostMetaBoxContentManager())->save_post($post_id, $post, $update);
        }, 10, 3);
