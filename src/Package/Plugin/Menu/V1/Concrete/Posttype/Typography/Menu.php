<?php
namespace Ababilithub\FlexAuthorization\Package\Plugin\Menu\V1\Concrete\Posttype\Typography;
...
use Ababilithub\{
    ...
    FlexAuthorization\Package\Plugin\Posttype\V1\Concrete\Typography\Posttype as TypographyPosttype
};
