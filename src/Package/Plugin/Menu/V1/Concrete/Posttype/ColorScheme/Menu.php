<?php
namespace Ababilithub\FlexAuthorization\Package\Plugin\Menu\V1\Concrete\Posttype\ColorScheme;
...
use Ababilithub\{
    ...
    FlexAuthorization\Package\Plugin\Posttype\V1\Concrete\ColorScheme\Posttype as ColorSchemePosttype
};
    ...
    class Menu extends BaseMenu
    {
        ...
        public function add_menu_items($menu_items = [])
        {
            $menu_items[] = [
                ...
                'menu_slug' => 'edit.php?post_type='.ColorSchemePosttype::POSTTYPE,
                'callback' => '',
                'position' => 3,
            ];
