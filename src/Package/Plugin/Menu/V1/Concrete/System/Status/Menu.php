<?php
namespace Ababilithub\FlexAuthorization\Package\Plugin\Menu\V1\Concrete\System\Status;
    ...
    class Menu extends BaseMenu
    {
        ...
        public function add_menu_items($menu_items = [])
        {
            $menu_items[] = [
                ...
                'menu_slug' => 'flex-authorization-system-status',
                'callback' => [$this,'show_server_status'],//[$this->option_box, 'render'],
                'position' => 7,
            ];
        ...
        {
            echo do_shortcode('[ababilithub-server-capacity-status]');
        }
